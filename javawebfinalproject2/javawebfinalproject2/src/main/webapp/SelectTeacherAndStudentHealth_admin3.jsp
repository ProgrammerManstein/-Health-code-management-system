...
<div class="container">
    <div class="row">
        <div class="col-12">
            <form class="form-horizontal form-inline col-12" id="tform" action="SelectTeacherHealth_admin3Servlet" method="post">
                ...
                <div class="form-group col-12 " >
                    ...
                    <select name="school" id="school" class="selectpicker form-control combox col-8" onchange="loadMajor();">
                        <option value="${AdminSchool}">${AdminSchool}</option>
                        <option value="${AdminSchool}">${AdminSchool}</option>
                    </select>
                </div>
                    ...
                    <%
                        if(YoN!=null)
                            if(teacherList!=null&&teacherList.size()>0){
                                i=0;
                                for(teacherBaseDate stu:teacherList){
